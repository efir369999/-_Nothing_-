...
# Complete Technical Specification v6
...
This document provides complete specifications for implementing the Proof of Time
protocol. It is designed to be self-sufficient: given only this document as input,

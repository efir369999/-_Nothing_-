...
- [Whitepaper](Asymptotic_Trust_Consensus.md) — Academic paper
- [Technical Specification](Asymptotic_Trust_Consensus_TECH_SPECIFICATION.md) — Implementation details
